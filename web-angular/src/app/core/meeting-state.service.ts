...
export class MeetingStateService {
    ...
    setCreated(value: CreateMeetingResponse): void {
        this.created.set(value);
        sessionStorage.setItem(CREATED_KEY, JSON.stringify(value))
    }

    setCallSummary(value: CallSummary): void {
        this.callSummary.set(value);
        sessionStorage.setItem(SUMMARY_KEY, JSON.stringify(value))
    }
